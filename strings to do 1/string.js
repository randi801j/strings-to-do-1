...
//from the string’s digits. You are allowed to use isNaN() and Number().
...
function acronym(str){
    ...
    for(let word in wordArry){
        if(wordArry[word].length>0){
            acronymString += wordArry[word][0].toUpperCase()
        }
    }
...
// Count Non-Spaces
// Create a function that, given a string, returns the number of 
//non-space characters found in the string. 
